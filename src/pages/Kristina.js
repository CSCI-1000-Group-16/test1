      ...
      <div className='container'>
        ...
        <main>
          <div className='underline'>
            <h1 className='title'>Hey, I'm Kristina. </h1>
          </div>
          <img
            className='pic'
          ...
          <p className='description'>
            Hey I am your friendly neighbourhood Spider Man. My real name is Kristina
            Nguyen. I am an actor but mostly I fight villains and juggle high school.
